...
language_resources = {
    "Python": {
        "resources": [
            ...
            ("Python for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-python-by-building-projects/"),
            ("Python Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/python/"),
        ],
        "image": "python.png"
    },
    "HTML": {
        "resources": [
            ...
            ("HTML Tutorial (freeCodeCamp)", "https://www.freecodecamp.org/news/html5-tutorial/"),
    ...
    "CSS": {
        "resources": [
            ...
            ("CSS Flexbox (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-css-flexbox-by-building-a-flexbox-portfolio/"),
    ...
    "JavaScript": {
        "resources": [
            ...
            ("JavaScript for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-javascript-full-course/"),
            ("JavaScript Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/javascript/"),
        ],
        "image": "js.png"
    },
    "React": {
        "resources": [
            ...
            ("React Tutorial (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-react-by-building-a-simple-app-d8d8b1f56f4f/"),
            ("Learn React (Codecademy)", "https://www.codecademy.com/learn/react-101"),
            ("React for Beginners (YouTube)", "https://www.youtube.com/results?search_query=react+beginner+tutorial"),
        ],
        "image": "react.png"
    },
    "Ruby": {
        "resources": [
            ...
            ("Ruby for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/ruby-for-beginners/"),
    ...
    "Java": {
        "resources": [
            ...
            ("Java for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/java-tutorial-for-beginners/"),
    ...
    "C++": {
        "resources": [
            ...
            ("C++ for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/c-plus-plus-tutorial/"),
            ("C++ Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/cplusplus/"),
        ],
        "image": "cpp.png"
    },
    "Kotlin": {
        "resources": [
            ...
            ("Kotlin for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-kotlin-by-building-android-apps/"),
            ("Kotlin Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/kotlin/"),
        ],
        "image": "kotlin.png"
    },
    "SQL": {
        "resources": [
            ...
            ("SQL for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/sql-for-beginners/"),
    ...
    "Swift": {
        "resources": [
            ...
            ("Swift for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-swift-programming/"),
            ("Swift Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/swift/"),
        ],
        "image": "swift.png"
    },
    "TypeScript": {
        "resources": [
            ...
            ("TypeScript for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-typescript-by-building-projects/"),
            ("TypeScript Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/typescript/"),
        ],
    ...
    "PHP": {
        "resources": [
            ...
            ("PHP for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-php-with-a-portfolio-project/"),
    ...
    "JSON": {
        "resources": [
            ...
            ("Learn JSON (W3Schools)", "https://www.w3schools.com/js/js_json_intro.asp"),
            ("JSON for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-json-in-5-minutes/"),
    ...
    "R": {
        "resources": [
            ...
            ("R for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-r-programming-for-beginners/"),
    ...
    "Dart": {
        "resources": [
            ...
            ("Dart for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/dart-programming-for-beginners/"),
    ...
    "Flutter": {
        "resources": [
            ...
            ("Flutter for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-flutter-for-beginners/"),
            ("Flutter Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/flutter/"),
        ],
        "image": "flutter.png"
    },
    "Firebase": {
        "resources": [
            ...
            ("Firebase for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-firebase-by-building-an-app/"),
            ("Firebase Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/firebase/"),
        ],
        "image": "firebase.png"
    },
    "Git": {
        "resources": [
            ...
            ("Git for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/git-and-github-for-beginners/"),
    ...
    "GitHub": {
        "resources": [
            ...
            ("GitHub for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-github-by-creating-a-repository/"),
            ("GitHub Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/github/"),
        ],
        "image": "github.png"
    },
    "Visual Studio Code": {
        "resources": [
            ...
            ("Learn VS Code (W3Schools)", "https://www.w3schools.com/whatis/whatis_vscode.asp"),
            ("VS Code for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-vscode-for-beginners/"),
            ("VS Code Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/visual_studio_code/"),
        ],
        "image": "vscode.png"
    },
    "PCB Design": {
        "resources": [
            ...
            ("PCB Design for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-pcb-design-with-eagle/"),
            ("PCB Design Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/pcb_design/"),
        ],
    ...
    "Arduino": {
        "resources": [
            ...
            ("Arduino for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-arduino-for-beginners/"),
            ("Arduino Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/arduino/"),
        ],
        "image": "arduino.png"
    },
    "Raspberry Pi": {
        "resources": [
            ...
            ("Learn Raspberry Pi (W3Schools)", "https://www.w3schools.com/raspberry_pi/"),
            ("Raspberry Pi for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-raspberry-pi-for-beginners/"),
            ("Raspberry Pi Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/raspberry_pi/"),
        ],
    ...
    "Linux": {
        "resources": [
            ...
            ("Linux for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/linux-for-beginners/"),
            ("Linux Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/linux/"),
        ],
        "image": "linux.png"
    },
    "AI": {
        "resources": [
            ...
            ("AI for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/artificial-intelligence-for-beginners/"),
            ("AI Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/artificial_intelligence/"),
        ],
        "image": "ai.png"
    },
    "CAD": {
        "resources": [
            ...
            ("CAD for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/cad-for-beginners/"),
    ...
    "Angular": {
        "resources": [
            ...
            ("Angular for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-angular-for-beginners/"),
            ("Angular Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/angular/"),
        ],
        "image": "angular.png"
    },
    ".NET": {
        "resources": [
            ...
            (".NET for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-net-for-beginners/"),
            (".NET Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/dotnet/"),
        ],
        "image": "dotnet.png"
    },
    "Electron": {
        "resources": [
            ...
            ("Electron for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/electron-for-beginners/"),
            ("Electron Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/electron/"),
        ],
        "image": "electron.png"
    },
    "MySQL": {
        "resources": [
            ...
            ("MySQL for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/mysql-for-beginners/"),
            ("MySQL Tutorials (TutorialsPoint)", "https://www.tutorialspoint.com/mysql/"),
        ],
        "image": "mysql.png"
    },
    "NPM": {
        "resources": [
            ...
            ("NPM for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/npm-for-beginners/"),
    ...
    "Vue": {
        "resources": [
            ...
            ("Vue for Beginners (freeCodeCamp)", "https://www.freecodecamp.org/news/learn-vue-for-beginners/"),
...
tech_stack_var = tk.StringVar(value=tech_stack_names[0])  # Default to the first tech stack
tech_stack_menu = ttk.Combobox(root, textvariable=tech_stack_var, values=tech_stack_names, state="readonly", width=40)
