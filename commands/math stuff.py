...
COMMANDS_PATH = Path(__file__).parent / "math"
...
class SquidlyFolderTools:
    def __init__(self, root):
        ...
        buttons = [
            ("arithmatic", IMAGES_PATH / "arithmatic.png"),
            ("algebra", IMAGES_PATH / "algebra.png"),
            ("graphing", IMAGES_PATH / "graphing.png"),
            ("geometry", IMAGES_PATH / "geometry.png"),
