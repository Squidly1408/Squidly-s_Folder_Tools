...
def create_flutter_project():
    ...
    project_name = simpledialog.askstring("Project Name", "Enter the Flutter project name:")
    ...
    if project_name:
        ...
        try:
            ...
            result = subprocess.run([flutter_path, 'create', project_path], check=True, capture_output=True, text=True)
             # Show success message
            messagebox.showinfo("Success", f"Flutter project '{project_name}' created successfully at {project_path}.")
            print(f"Flutter project '{project_name}' created successfully at {project_path}.")
